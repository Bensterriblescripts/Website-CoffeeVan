...
export default function Navbar() { 
    return (
        <nav>
            <div className="select-none md:w-5/6 sm:w-screen bg-pink-300 md:h-20 sm:h-15 mx-auto text-center flex justify-between items-center md:rounded-lg sm:rounded-lg mt-4">
